...
export default function BasketItem({ item }: Props) { 
  const[removeBasketItem] = useRemoveBasketItemMutation(); //usage of the hook from basketApi
    const[addBasketItem] = useAddBasketItemMutation(); //usage of the hook from basketApi
